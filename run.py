...
def main():
    ...
    parser.add_argument('--model', type=str, default='Autoformer', help='model name, options: ['
                                                                        'Autoformer, Informer, '
                                                                        'Transformer]')
    ...
    parser.add_argument('--label_len', type=int, default=48, help='start token length')  # 这里的label_len作为解码器的一部分输入（另一部分是全0，即掩码）
    parser.add_argument('--pred_len', type=int, default=96, help='prediction sequence length')  # 解码器的输出
    ...
    parser.add_argument('--d_ff', type=int, default=2048, help='dimension of fcn')  # 全连接层的维度?
